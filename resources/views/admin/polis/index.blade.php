...
<a href="{{ route('polis.create') }}" 
   class="btn bg-[#2d4499] hover:bg-[#1e2d6b] text-white border-none px-6 py-2 rounded-lg shadow-sm flex items-center gap-2 transition-all">
    <i class="fas fa-plus text-xs"></i>
    <span class="font-semibold">Tambah Poli</span>
</a>
    </div>
